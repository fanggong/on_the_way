...
- v0.3.0 后端 Garmin 连接器启动与验收: `docs/run/交付物启动与验收说明_v0.3.0.md`

## Product / API Docs

- v0.3.0 产品文档: `docs/product/product_v0.3.0.md`
- v0.3.0 API 文档: `docs/api/api_v0.3.0.md`
